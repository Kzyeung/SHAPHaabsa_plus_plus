...
tf.app.flags.DEFINE_integer('n_iter', 8, 'number of train iter')  # by default 200
...
# tf.app.flags.DEFINE_string("embedding_path","C:\\Users\\Kelvin\\Desktop\\Thesis\\Prior Papers\\HAABSA_plusplus\\venv\\data\\programGeneratedData\\" +'small_'+ str(FLAGS.embedding_dim)+'embedding'+str(FLAGS.year)+".txt" , "pre-trained glove vectors file path")
# tf.app.flags.DEFINE_string("remaining_test_path", "C:\\Users\\Kelvin\\Desktop\\Thesis\\Prior Papers\\HAABSA_plusplus\\venv\\data\\programGeneratedData\\" +'small_'+ str(FLAGS.embedding_dim)+'remainingtestdata'+str(FLAGS.year)+".txt", "formatted remaining test data path after ontology")
