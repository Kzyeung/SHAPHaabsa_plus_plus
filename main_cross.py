...
def main(_):
    ...
    BASE_train = "C:/Users/Kelvin/Desktop/Thesis/Prior Papers/HAABSA_plusplus/venv/data/programGeneratedData/crossValidation"+str(FLAGS.year)+'/cross_train_'
    BASE_val = "C:/Users/Kelvin/Desktop/Thesis/Prior Papers/HAABSA_plusplus/venv/data/programGeneratedData/crossValidation"+str(FLAGS.year)+'/cross_val_'
    BASE_svm_train = "C:/Users/Kelvin/Desktop/Thesis/Prior Papers/HAABSA_plusplus/venv/data/programGeneratedData/crossValidation"+str(FLAGS.year)+'/svm/cross_train_svm_'
    BASE_svm_val = "C:/Users/Kelvin/Desktop/Thesis/Prior Papers/HAABSA_plusplus/venv/data/programGeneratedData/crossValidation"+str(FLAGS.year)+'/svm/cross_val_svm_'


    REMAIN_val = "C:/Users/Kelvin/Desktop/Thesis/Prior Papers/HAABSA_plusplus/venv/data/programGeneratedData/crossValidation"+str(FLAGS.year)+'/cross_val_remainder_'
    REMAIN_svm_val = "C:/Users/Kelvin/Desktop/Thesis/Prior Papers/HAABSA_plusplus/venv/data/programGeneratedData/crossValidation"+str(FLAGS.year)+'/svm/cross_val_remainder_'
    ...
    if runLCRROTALT == True:
        ...
        for i in range(split_size):
            ...
            tf.reset_default_graph()
            print('iteration: '+ str(i))
        with open("C:/Users/Kelvin/Desktop/Thesis/Prior Papers/HAABSA_plusplus/venv/data/programGeneratedData/crossValidation"+str(FLAGS.year)+'/cross_results_"+str(FLAGS.year)+"/LCRROT_ALT_"+str(FLAGS.year)+'.txt', 'w') as result:
            result.write(str(acc))
            result.write('Accuracy: {}, St Dev:{} /n'.format(np.mean(np.asarray(acc)), np.std(np.asarray(acc))))
            print(str(split_size)+'-fold cross validation results')
            print('Accuracy: {}, St Dev:{}'.format(np.mean(np.asarray(acc)), np.std(np.asarray(acc))))
