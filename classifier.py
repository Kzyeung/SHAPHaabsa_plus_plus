...
class classifier:
    ...
    def __init__(self, model, input_file):
        ...
        if model == 'Olaf':
            ...
            write_path = 'C:\\Users\\Kelvin\\Desktop\\Thesis\\Prior Papers\\HAABSA_plusplus\\venv\\data\\Counterfactuals' + model + str(2016)
            # small_768remainingtestdata2016
            self.input_file = input_file
            self.model_path = 'C:\\Users\\Kelvin\\Desktop\\Thesis\\Prior Papers\\HAABSA_plusplus\\venv\\trainedModelMaria\\2016\\Best\\-9212'  # was /-3, /-94, /-18800

        self.model = model
        # \\programGeneratedData\\" + "small_" + str(
        self.word_id_mapping, self.w2v = load_w2v(
            "C:\\Users\\Kelvin\\Desktop\\Thesis\\Prior Papers\\HAABSA_plusplus\\venv\\data\\programGeneratedData\\" + str(
