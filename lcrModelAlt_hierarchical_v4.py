...
def main(train_path, test_path, accuracyOnt, test_size, remaining_size, learning_rate=0.09, keep_prob=0.3, momentum=0.85, l2=0.00001):
    ...
    with tf.Session(config=config) as sess:
        ...
        #best_dir = 'trainedModelMaria/' + str(FLAGS.year) + '/' + 'Best/'
        ...
        for i in range(FLAGS.n_iter):
            ...
            Avg_time_iter = Time_passed / (i+1)
            Iter_left = FLAGS.n_iter - (i+1)
            print("Average time per iter: ", Avg_time_iter, "ETA: ", (Avg_time_iter * Iter_left), "Maxx_acc = ", max_acc)
