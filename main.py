...
#Set start time to measure total time for program
...
def main(_):
    ...
    if useOntology == True:
        ...
        print('train acc = {:.4f}, test acc={:.4f}, remaining size={:.4f}'.format(accuracyInSampleOnt, accuracyOnt, remaining_size))
    else:
        if runSVM == True:
