...
1.5	Create a virtual environment in a desired location by running the following command: virtualenv ENV_NAME
1.6	Direct to the virtual environment source directory. 
1.7	Unzip the HAABSA_software.zip file in the virtual environment directory.
